...
void FitHist::ShowFitParameters()
{
    ...
    cout << endl;
    cout << "Spe information: " << endl;
    cout << "spe_value = " << params.spe_value << " +- " << params.spe_value_err << endl;
    cout << "pedestal_shift = " << params.pedestal_shift << " +- " << params.pedestal_shift_err << endl;

...
{
    std::cout << "You are in MyMainFrame::DoDraw(DataStr* data_str)" << std::endl;
...
//    std::cout << "Current thread is" << this_id << std::endl;
    ...
    TF1 *f1 = new TF1("f1","sin(x)/x",0,gRandom->Rndm()*10); std::cout << __FILE__ << "; " << __LINE__ << std::endl;
    f1->SetLineWidth(3); std::cout << __FILE__ << "; " << __LINE__ << std::endl;

    //ch_0
    TCanvas *fCanvas = fEcanvas->GetCanvas(); std::cout << __FILE__ << "; " << __LINE__ << std::endl;
    fCanvas->cd(); std::cout << __FILE__ << "; " << __LINE__ << std::endl;
    f1->Draw(); std::cout << __FILE__ << "; " << __LINE__ << std::endl;
    fCanvas->Update(); std::cout << __FILE__ << "; " << __LINE__ << std::endl;

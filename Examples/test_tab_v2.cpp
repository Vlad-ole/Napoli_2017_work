...
//example from https://root-forum.cern.ch/t/gui-using-tgtab/21468/2
// .x test_tab.cpp
...
void test_tab_v2()
{
   ...
   TGCompositeFrame *hf_tab1 = new TGCompositeFrame(tf, 60, 20, kHorizontalFrame);
   TRootEmbeddedCanvas *fEc1_tab1 = new TRootEmbeddedCanvas("ec1_tab1", hf_tab1, 100, 100);
   hf_tab1->AddFrame(fEc1_tab1, new TGLayoutHints(kLHintsTop | kLHintsLeft | kLHintsExpandX |kLHintsExpandY, 5, 5, 5, 5));
   tf->AddFrame(hf_tab1, new TGLayoutHints(kLHintsTop | kLHintsLeft | kLHintsExpandX |kLHintsExpandY, 5, 5, 5, 5));
